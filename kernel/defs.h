...
struct proc*    myproc();
struct vma*     proc_find_vma(struct proc*, uint64);
uint64          proc_mmap_limit(struct proc*);
uint64          proc_vm_top(struct proc*);
void            proc_vm_init(struct proc*);
void            procinit(void);
...
void            sched_proc_init_hook(struct proc*);
void            sched_proc_exit_hook(struct proc*);
void            sched_proc_tick_hook(struct proc*);
void            sched_proc_wakeup_hook(struct proc*);
